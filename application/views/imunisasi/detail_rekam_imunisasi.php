				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"> 
							...
							<?php foreach ($detail_rekam_pasien_imunisasi as $row): ?>

								<h4 style="font-weight: bold;margin-top: 10px;"><?php echo ucwords($row->kode_imunisasi);?></h4>								
							<?php endforeach ?>
						...
						<table  id="tabel_rekamfinal" class="table-responsive">
							<tbody>
								...
								<tr>
									<th  class="judul1">Kunjungan Neonatus</th>											
									<td class="isi"  colspan="4"><?php echo $row->kunjungan_neonatus ?></td>
								</tr>
								<tr>
								...
								<tr>
									<th  class="judul1">Jenis Imunisasi</th>											
									<td class="isi"  colspan="4"><?php echo $row->jenis_imunisasi ?></td>
								</tr>
