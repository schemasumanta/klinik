<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($edit_rekam_imunisasi as $row){ ?>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control"  id="kode_imunisasi" name="kode_imunisasi" value="<?php echo $row->kode_imunisasi ?>"  onclick="this.blur()"  style="border-color: #03b509; background: #ffffff" >
											</div>  
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-3 mb-3">
												...
												<input type="text" class="form-control"  id="kunjungan_neonatus" name="kunjungan_neonatus"  style="border-color: #03b509; background: #ffffff" value="<?php echo $row->kunjungan_neonatus ?>" >
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="pb" name="pb"  style="border-color: #03b509; background: #ffffff"  value="<?php echo $row->pb ?>">
											</div>
											...
											<div class="col-md-3 mb-3">
												<span class="input-group-text labelkolom">Jenis Imunisasi</span>
												<select type="text" rows="3" class="form-control "  id="jenis_imunisasi" name="jenis_imunisasi" style="border-color: #03b509; background: #ffffff" value="<?php echo $row->jenis_imunisasi ?>" >   

													<option value="<?php echo $row->jenis_imunisasi ?>" selected="selected" > <?php echo $row->jenis_imunisasi ?></option>
											...
											<div class="col-md-6 mb-3">
												...
												<textarea type="text" class="form-control"  id="diagnosa" name="diagnosa"  style="border-color: #03b509; background: #ffffff"> <?php echo $row->diagnosa ?> </textarea>
											</div> 
			...
			<script type="text/javascript">
				...
				$('#update_data_rekam').on('click',function(){
					...
					if (cek=='false') {
						...
						let link = '<?php echo base_url()?>imunisasi/updaterekam_imunisasi/'+total_akhir;
