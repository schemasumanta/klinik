<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($edit_rekam_nifas as $row){ ?>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control"  id="kode_nifas" name="kode_nifas" value="<?php echo $row->kode_nifas ?>"  onclick="this.blur()"  style="border-color: #03b509; background: #ffffff" >
											</div>  
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-4 mb-3">
												...
												<input type="number" rows="3" class="form-control"  id="kunjungan" name="kunjungan"  value="<?php echo $row->kunjungan ?>" style="border-color: #03b509; background: #ffffff" >  
											...
											<div class="col-md-8 mb-3">
												...
												<textarea type="text" class="form-control"  id="subjektif" name="subjektif" style="border-color: #03b509; background: #ffffff; " >  <?php echo $row->subjektif ?></textarea>
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="keadaan_umum" name="keadaan_umum"  value="<?php echo $row->keadaan_umum ?>" style="border-color: #03b509; background: #ffffff; text-align: center;" >
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="kesadaran" name="kesadaran"  value="<?php echo $row->kesadaran ?>" style="border-color: #03b509; background: #ffffff; " >
											</div>


											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Tekanan Darah</span> 
												<input type="text" class="form-control"  id="tekanan_darah" name="tekanan_darah"  value="<?php echo $row->tekanan_darah ?>"  style="border-color: #03b509; background: #ffffff">
											</div>  

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Nadi</span> 
												<input type="text" class="form-control"  id="nadi" name="nadi"   value="<?php echo $row->nadi ?>" style="border-color: #03b509; background: #ffffff">
											</div>  

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Respirasi</span> 
												<input type="text" class="form-control"  id="respirasi" name="respirasi"  value="<?php echo $row->respirasi ?>"  style="border-color: #03b509; background: #ffffff">
											</div>  
											...
											<div class="col-md-3 mb-3"> 
												...
												<input type="text" class="form-control" id="suhu" name="suhu"   value="<?php echo $row->suhu ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 
											...
											<div class="col-md-3 mb-3"> 
												...
												<input type="text" class="form-control"  id="bb" name="bb"   value="<?php echo $row->bb ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">tb</span> 
												<input type="text" class="form-control"  id="tb" name="tb"   value="<?php echo $row->tb ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Payudara</span> 
												<input type="text" class="form-control"  id="payudara" name="payudara"  value="<?php echo $row->payudara ?>"  style="border-color: #03b509; background: #ffffff">
											</div>  


											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Asi</span> 
												<input type="text" class="form-control"  id="asi" name="asi"  value="<?php echo $row->asi ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 


											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Tfu</span> 
												<input type="text" class="form-control"  id="tfu" name="tfu"  value="<?php echo $row->tfu ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 


											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Kotraksi</span> 
												<input type="text" class="form-control"  id="kotraksi" name="kotraksi"  value="<?php echo $row->kotraksi ?>"  style="border-color: #03b509; background: #ffffff">
											</div> 

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Pendarahan</span> 
												<input type="text" class="form-control"  id="pendarahan" name="pendarahan"  value="<?php echo $row->pendarahan ?>"   style="border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Lokhea</span> 
												<input type="text" class="form-control"  id="lokhea" name="lokhea"  value="<?php echo $row->lokhea ?>"  style="border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Perineum</span> 
												<input type="text" class="form-control"  id="perineum" name="perineum"   value="<?php echo $row->perineum ?>" style="border-color: #03b509; background: #ffffff">
											</div>


											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Kandungan Kemih</span> 
												<input type="text" class="form-control"  id="kandungan_kemih" name="kandungan_kemih"  value="<?php echo $row->kandungan_kemih ?>"   style="border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Oedema</span> 
												<input type="text" class="form-control"  id="oedema" name="oedema"     value="<?php echo $row->oedema ?>"style="border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Assesment</span> 
												<input type="text" class="form-control"  id="assesment" name="assesment"  value="<?php echo $row->assesment ?>"  style="border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Plening</span> 
												<input type="text" class="form-control"  id="plening" name="plening"  value="<?php echo $row->plening ?>" style="border-color: #03b509; background: #ffffff">
											</div>
										...
										<?php $i=1; foreach ($detail_obat as $key) {?>
											...
											<div class="row mb-6"> 
												<div class="col-md-12" style="margin-top: 70px;">
													...
													<a href="<?php echo site_url('nifas') ?>" class="btn btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
			...
			<script type="text/javascript">
				...
				$('#update_data_rekam').on('click',function(){
					...
					if (cek=='false') {
						...
						let link = '<?php echo base_url()?>nifas/updaterekam_nifas/'+total_akhir;
