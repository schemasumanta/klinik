<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($periksa_nifas as $row){ ?>

						<div class="card-header">     
							<div class="row">
								<div class="col-md-12">
									<img src="<?php echo base_url() ?>assets/img/user.png" style="border-radius: 50%" width="60px" height="60px">
									<h4 style="position: absolute; right: 0;top:0;margin-right: 30px;font-weight: bold;color: green">REKAM DATA PENGOBATAN NIFAS</h4>
							...
							<!-- The modal -->
							<div class="modal fade" id="ModalRiwayatPasiennifas" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
								<div class="modal-dialog modal-lg" role="document" >
									<div class="modal-content" >
										<div class="modal-header" style="background:#115222">
											<h4 class="modal-title" id="modalLabel">Daftar Riwayat Pasien NIFAS - <?php echo ucwords($row->nama_pasien) ?></h4>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class="col-md-4 mb-3"> 
												...
												<input type="text" class="form-control"  id="kode_nifas" name="kode_nifas" value="<?php echo $row->kode_nifas ?>" style="border-color: #03b509; background: #ffffff"  onclick="this.blur()">
											</div>   
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-4 mb-3">
												...
												<span class="input-group-text labelkolom">Kunjungan </span> 
												<input type="number" rows="3" class="form-control"  id="kunjungan" name="kunjungan" style="border-color: #03b509; background: #ffffff" >  
											...
											<div class="col-md-8 mb-3">
												...
												<textarea type="text" class="form-control"  id="subjektif" name="subjektif" style="border-color: #03b509; background: #ffffff; " ></textarea>
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="keadaan_umum" name="keadaan_umum" style="border-color: #03b509; background: #ffffff; text-align: center;" >
											</div>
											...
											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Tekanan Darah</span> 
												<input type="text" class="form-control"  id="tekanan_darah" name="tekanan_darah"   style="border-color: #03b509; background: #ffffff">
											</div>  

											<!-- <div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Nadi</span> 
												<input type="text" class="form-control"  id="nadi" name="nadi"   style="border-color: #03b509; background: #ffffff">
											</div>   -->

											<div class="col-md-3 mb-3"> 
												<span class="input-group-text labelkolom">Respirasi</span> 
												<input type="text" class="form-control"  id="respirasi" name="respirasi"   style="border-color: #03b509; background: #ffffff">
											</div>  
<!-- 
												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Suhu</span> 
													<input type="text" class="form-control"  id="suhu" name="suhu"   style="border-color: #03b509; background: #ffffff">
												</div>  --> 

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Payudara</span> 
													<input type="text" class="form-control"  id="payudara" name="payudara"   style="border-color: #03b509; background: #ffffff">
												</div>  


												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Asi</span> 
													<input type="text" class="form-control"  id="asi" name="asi"   style="border-color: #03b509; background: #ffffff">
												</div> 


												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Tfu</span> 
													<input type="text" class="form-control"  id="tfu" name="tfu"   style="border-color: #03b509; background: #ffffff">
												</div> 


												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Kotraksi</span> 
													<input type="text" class="form-control"  id="kotraksi" name="kotraksi"   style="border-color: #03b509; background: #ffffff">
												</div> 

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Pendarahan</span> 
													<input type="text" class="form-control"  id="pendarahan" name="pendarahan"   style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Lokhea</span> 
													<input type="text" class="form-control"  id="lokhea" name="lokhea"   style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Perineum</span> 
													<input type="text" class="form-control"  id="perineum" name="perineum"   style="border-color: #03b509; background: #ffffff">
												</div>


												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Kandungan Kemih</span> 
													<input type="text" class="form-control"  id="kandungan_kemih" name="kandungan_kemih"   style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Oedema</span> 
													<input type="text" class="form-control"  id="oedema" name="oedema"   style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Assesment</span> 
													<input type="text" class="form-control"  id="assesment" name="assesment"   style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Plening</span> 
													<input type="text" class="form-control"  id="plening" name="plening" style="border-color: #03b509; background: #ffffff">
												</div>

												<div class="col-md-6 mb-3"> 
													<span class="input-group-text labelkolom">Tindakan / Rencana</span> 
													<textarea type="text" rows="3" class="textarea_atas form-control"  id="tindakan_dokter" name="tindakan_dokter"  required="required" style="border-color: #03b509; background: #ffffff"></textarea> 
												</div>
											...
											<br>
													...
													<br>
													<div class="row" id="obat1" style="border: 1px solid #e4e4e4;padding-top: 10px;border-color: #03b509;"> 
												...
												<div class="row mb-6">  
													<div class="col-md-12" style="margin-top: 70px;">
														...
														<a href="<?php echo site_url('nifas') ?>" class="btn btn-sm btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
														<button id="simpan_data_nifas" type="button" class="btn btn-sm btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i> SIMPAN DATA REKAM</button> 
													</div> 
												</div>
											</div> 
			...
			<div class="modal fade" id="modal_lihat" tabindex="-1" role="dialog" aria-labelledby="modal_lihat_stok" aria-hidden="true">
				...
				<script type="text/javascript">
					...
					$('#simpan_data_nifas').on('click',function(){
					...
					let link = '<?php echo base_url()?>nifas/simpanrekam_nifas/'+total_akhir;
					...
					$('#btn_riwayat').on('click',function(){
						...
						$.ajax({
							type  : 'GET',
							url   : '<?php echo base_url()?>nifas/riwayat_rekam_nifas',
							dataType : 'json',
							data:{'kode_pasien':kode_pasien,'kategori':kategori},
							success : function(data){
								$('#ModalRiwayatPasiennifas').modal('show');
					...
					function showdetail(kode){
						...
						let kode_nifas = $('#kode_nifas'+kode).html().replace('/','garing'); 
						...
						$(".listdetail").load("<?php echo base_url()?>nifas/detail_riwayat/"+kode_nifas);
					...
					html+='<div class="row" id="obat'+kode_baru+'" style="border: 1px solid #e4e4e4;padding-top: 10px;border-color: #03b509;">'+ 
					'<div class="input-group mb-3 col-md-8 listobat">'+
					'<div class="input-group-prepend">'+
