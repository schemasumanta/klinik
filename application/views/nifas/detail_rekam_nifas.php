				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"> 
							...
							<?php foreach ($detail_rekam_pasien_nifas as $row): ?>

								<h4 style="font-weight: bold;margin-top: 10px;"><?php echo ucwords($row->kode_nifas);?></h4>								
							<?php endforeach ?>
						...
						<table  id="tabel_rekamfinal" class="table-responsive">
							<tbody>
								...
								<tr>
									...
									<td class="isi"  colspan="4"><?php echo $row->kunjungan ?></td>
								</tr>
								<tr>
								...
								<tr>
									<th  class="judul1">Keadaan Umum</th>											
									<td class="isi"  colspan="4"><?php echo $row->keadaan_umum ?></td>
								</tr>

								<tr>
									<th  class="judul1">Kesadaran</th>											
									<td class="isi"  colspan="4"><?php echo $row->kesadaran ?></td>
								</tr>

								<tr>
									<th  class="judul1">tekanan_darah</th>											
									<td class="isi"  colspan="4"><?php echo $row->keadaan_umum ?></td>
								</tr>

								<tr>
									<th  class="judul1">Nadi</th>											
									<td class="isi"  colspan="4"><?php echo $row->nadi ?></td>
								</tr>


								<tr>
									<th  class="judul1">Suhu</th>											
									<td class="isi"  colspan="4"><?php echo $row->suhu ?></td>
								</tr>

								<tr>
									<th  class="judul1">Payudarah</th>											
									<td class="isi"  colspan="4"><?php echo $row->payudara ?></td>
								</tr>

								

								<tr>
									<th  class="judul1">asi</th>											
									<td class="isi"  colspan="4"><?php echo $row->asi ?></td>
								</tr>

								<tr>
									<th  class="judul1">Tfu</th>											
									<td class="isi"  colspan="4"><?php echo $row->tfu ?></td>
								</tr>

								<tr>
									<th  class="judul1">pendarahan</th>											
									<td class="isi"  colspan="4"><?php echo $row->pendarahan ?></td>
								</tr>

								<tr>
									<th  class="judul1">lokhea</th>											
									<td class="isi"  colspan="4"><?php echo $row->lokhea ?></td>
								</tr>
								...
								<tr>
									<th  class="judul1">Plening</th>											
									<td class="isi"  colspan="4"><?php echo $row->plening ?></td>
								</tr>

									<tr>
									<th  class="judul1">Tindakan Rencana </th>											
								...
								<tr style="background: #03b509;color: white; border: 1px solid  #10aad8;">
									<td style="height:40px;font-weight:bold;text-align: left;" colspan="6">&nbsp;&nbsp;&nbsp;Resep Obat</td>	
								</tr>
								<tr class="pemisah">
									<td colspan="2"></td>
									<td ></td>
									...
									<th class="qty" colspan="1">Qty</th>

								</tr>

								<?php foreach ($detail_obat as $key) {?>
									<tr>
										<td  class="isi" colspan="2"><?php echo $key->nama_obat; ?> || <?php echo $key->keterangan; ?> </td>	 											 
										<td  class="isi" colspan="2"><?php echo $key->aturan_pakai; ?></td>	
										<td class="isi text-center" colspan="1"><?php echo $key->qty; ?></td>
								</tr>
