	...
	<div class="content">
		<div class="page-inner">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<?php foreach ($periksa_bbl as $row){ ?>
							...
							<div class="card-header">     
								...
								<!-- The modal -->
								<div class="modal fade" id="ModalRiwayatPasienbbl" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document" >
										<div class="modal-content" >
											<div class="modal-header" style="background:#115222">
												<h4 class="modal-title" id="modalLabel">Daftar Riwayat Pasien BBL - <?php echo ucwords($row->nama_pasien) ?></h4>
								...
								<div class="card-body">  
									<form class="form-horizontal simpandata" method="post" id="form1" name="form1">
										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom"> KODE REKAM BBL</span> 
													<input type="text" class="form-control"  id="kode_bbl" name="kode_bbl" value="<?php echo $row->kode_bbl ?>" style="border-color: #03b509; background: #ffffff"  onclick="this.blur()">
												</div>   
										...
										<br>
										<div class="row col-md-12x" style="background:#03b509;" > 
											<h6 type="button transparent" onclick="hidecustomer()" style="letter-spacing:3px;color:white; background:#03b509;margin-top: 10px; margin-left: 10px;" data-toggle="collapse" href="#customer_collapse" role="button" aria-expanded="false" aria-controls="customer_collapse"><b>DIAGNOSIS PASIEN</b></h6>
										...
										<div class="col-md-12x mt-3"> 
											<div class="row">
												...
												<!-- 	<input type="date" class="form-control"  id="tanggal_periksa" name="tanggal_periksa"  style="border-color: #03b509; background: #ffffff"> -->
												</div>
												...
												<div class="col-md-6 mb-3">
													...
													<input type="number" class="form-control"  id="kunjungan" name="kunjungan" style="border-color: #03b509; background: #ffffff" >
												</div>
												...
												<div class="col-md-4 mb-3">
													...
													<input type="date" class="form-control"  id="tgl_kunjungan" name="tgl_kunjungan" style="border-color: #03b509; background: #ffffff" >
												</div>
											...
											<div class="col-md-12x mt-3"> 
												<div class="row">
													...
													<div class="col-md-12 mb-3"> 
														...
														<input type="text" class="form-control"  id="subjektif" name="subjektif" style="border-color: #03b509; background: #ffffff" >
													</div>
											...
											<div class="col-md-12x mt-3"> 
												<div class="row"> 
													<div class="col-md-3 mb-3" style="display: none;"> 
														...
														<input type="text" class="form-control"  id="objektif" name="objektif"  style="border-color: #03b509; background: #ffffff" >
													</div>

													<div class="col-md-3 mb-3" style="display: none;"> 
														<span class="input-group-text labelkolom">TTV</span> 
														<input type="text" class="form-control"  id="ttv" name="ttv"  style="border-color: #03b509; background: #ffffff" >
													</div>

													<div class="col-md-3 mb-3"> 
														<span class="input-group-text labelkolom">Kesadaran</span> 
														<input type="text" class="form-control"  id="kesadaran" name="kesadaran"  style="border-color: #03b509; background: #ffffff" >
													</div> 

													<div class="col-md-3 mb-3"> 
														<span class="input-group-text labelkolom">Tonus Otot</span> 
														<input type="text" class="form-control"  id="tonus_otot" name="tonus_otot"   style="border-color: #03b509; background: #ffffff">
													</div> 


													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Kulit</span> 
														<input type="text" rows="3" class="form-control"  id="kulit" name="kulit" style="border-color: #03b509; background: #ffffff" > 
													</div>


													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Respirasi</span> 
														<input type="text" rows="3" class="form-control"  id="respirasi" name="respirasi" style="border-color: #03b509; background: #ffffff" > 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Detak jantung</span> 
														<input type="text" rows="3" class="form-control"  id="detak_jantung" name="detak_jantung" style="border-color: #03b509; background: #ffffff" > 
													</div>

												<!-- <div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Suhu</span> 
													<input type="text" rows="3" class="form-control"  id="suhu" name="suhu" style="border-color: #03b509; background: #ffffff"> 
												</div> -->

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Kepala</span> 
													<input type="text" rows="3" class="form-control"  id="kepala" name="kepala" style="border-color: #03b509; background: #ffffff"> 
												</div>

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Mata</span> 
													<input type="text" rows="3" class="form-control"  id="mata" name="mata" style="border-color: #03b509; background: #ffffff"> 
												</div>

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Mulut</span> 
													<input type="text" rows="3" class="form-control"  id="mulut" name="mulut" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Perut & Tali Pusat</span> 
													<input type="text" rows="3" class="form-control"  id="perut_telinga_pusat" name="perut_telinga_pusat" style="border-color: #03b509; background: #ffffff"> 
												</div>  

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Punggung</span> 
													<input type="text" rows="3" class="form-control"  id="punggung" name="punggung" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Lubang Anus</span> 
													<input type="text" rows="3" class="form-control"  id="lubang_anus" name="lubang_anus" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Alat Kelamin</span> 
													<input type="text" rows="3" class="form-control"  id="alat_kelamin" name="alat_kelamin" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Berat Badan</span> 
													<input type="text" rows="3" class="form-control"  id="bb" name="bb" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<!-- <div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Panjang Badan</span> 
													<input type="text" rows="3" class="form-control"  id="pb" name="pb" style="border-color: #03b509; background: #ffffff"> 
												</div>  -->

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Lingkaran Kepala</span> 
													<input type="text" rows="3" class="form-control"  id="lingkar_kepala" name="lingkar_kepala" style="border-color: #03b509; background: #ffffff"> 
												</div> 

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Lingkaran Dada</span> 
													<input type="text" rows="3" class="form-control"  id="lingkar_dada" name="lingkar_dada" style="border-color: #03b509; background: #ffffff"> 
												</div> 
										...
										<div class="col-md-12x mt-3"> 
											<div class="row">
												<div class="col-md-3 mb-3">
													...
													<input type="text" rows="3" class="form-control"  id="refleks" name="refleks" style="border-color: #03b509; background: #ffffff"> 
												</div>

												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Rooting</span> 
													<input type="text" rows="3" class="form-control"  id="r_rooting" name="r_rooting" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Swalowing</span> 
													<input type="text" rows="3" class="form-control"  id="r_swalilong" name="r_swalilong" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Sucking</span> 
													<input type="text" rows="3" class="form-control"  id="r_sucking" name="r_sucking" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Eyeblink </span> 
													<input type="text" rows="3" class="form-control"  id="r_eyeblink" name="r_eyeblink" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Graps</span> 
													<input type="text" rows="3" class="form-control"  id="r_graps" name="r_graps" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Moro</span> 
													<input type="text" rows="3" class="form-control"  id="r_moro" name="r_moro" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Babinski </span> 
													<input type="text" rows="3" class="form-control"  id="r_babinski" name="r_babinski" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Tonic Neck </span> 
													<input type="text" rows="3" class="form-control"  id="r_tonic_neck" name="r_tonic_neck" style="border-color: #03b509; background: #ffffff"> 
												</div>
												<div class="col-md-3 mb-3">
													<span class="input-group-text labelkolom">Reflek Labirin</span> 
													<input type="text" rows="3" class="form-control"  id="r_labirin" name="r_labirin" style="border-color: #03b509; background: #ffffff"> 
												</div>
											...
											<div class="col-md-12x mt-3"> 
												<div class="row">
													...
													<div class="col-md-3 mb-3">
														...
														<input type="text" rows="3" class="form-control"  id="assesment" name="assesment" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Planing</span> 
														<input type="text" rows="3" class="form-control"  id="planning" name="planning" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Inisiasi Menyusui Dini</span> 
														<input type="text" rows="3" class="form-control"  id="inisial_menyusui" name="inisial_menyusui" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Jaga bayi tetap hangat</span> 
														<input type="text" rows="3" class="form-control"  id="jaga_bayi_tetap_hangat" name="jaga_bayi_tetap_hangat" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Keringkan bayi</span> 
														<input type="text" rows="3" class="form-control"  id="kringkan_bayi" name="kringkan_bayi" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Salep mata antibiotika profilaksis</span> 
														<input type="text" rows="3" class="form-control"  id="salep_mata_antibiotik" name="salep_mata_antibiotik" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Suntik Neo-K</span> 
														<input type="text" rows="3" class="form-control"  id="suntik_neo" name="suntik_neo" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Imunisasi Hb0</span> 
														<input type="text" rows="3" class="form-control"  id="imunisasi_hbo" name="imunisasi_hbo" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Rawat gabung dengan ibu </span> 
														<input type="text" rows="3" class="form-control"  id="rawat_gabung" name="rawat_gabung" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Memandikan bayi</span> 
														<input type="text" rows="3" class="form-control"  id="memandikan_bayi" name="memandikan_bayi" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Konseling Menyusui</span> 
														<input type="text" rows="3" class="form-control"  id="konseling_menyusui" name="konseling_menyusui" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Tanda-tanda bahaya</span> 
														<input type="text" rows="3" class="form-control"  id="tanda_tanda_bahaya" name="tanda_tanda_bahaya" style="border-color: #03b509; background: #ffffff"> 
													</div>

													<div class="col-md-9 mb-3">
														<span class="input-group-text labelkolom">Menjelaskan pada ibu tentang perawatan bayi di rumah</span> 
														<textarea type="text" rows="3" class="form-control"  id="penjelasan" name="penjelasan" style="border-color: #03b509; background: #ffffff"></textarea>
													</div>

													<div class="col-md-3 mb-3">
														<span class="input-group-text labelkolom">Melengkapi catatan medis</span> 
														<textarea type="text" rows="3" class="form-control"  id="catatan_medis" name="catatan_medis" style="border-color: #03b509; background: #ffffff"> </textarea>
													</div>
											...
											<div class="row col-md-12x" style="background:#03b509;" > 
												<h6 type="button transparent" onclick="hidecustomer()" style="letter-spacing:3px;color:white; background:#03b509;margin-top: 10px; margin-left: 10px;" data-toggle="collapse" href="#customer_collapse" role="button" aria-expanded="false" aria-controls="customer_collapse"><b>TERAPI / PEMBERIAN OBAT </b></h6>
											...
											<br>
												...
												<div class="row mb-6"> 
													<div class="col-md-12" style="margin-top: 70px;">
														...
														<a href="<?php echo site_url('bbl') ?>" class="btn  btn-sm btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
														<button id="simpan_data_bbl" type="button" class="btn btn-sm btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i> SIMPAN DATA REKAM</button> 
													</div> 
												</div>
											</div> 
			...
			<div class="modal fade" id="modal_lihat" tabindex="-1" role="dialog" aria-labelledby="modal_lihat_stok" aria-hidden="true">
				...
				<script type="text/javascript">
					...
					$('#simpan_data_bbl').on('click',function(){
					...
					let link = '<?php echo base_url()?>bbl/simpanrekam_bbl/'+total_akhir;
					...
					$('#btn_riwayat').on('click',function(){
						...
						$.ajax({
							type  : 'GET',
							url   : '<?php echo base_url()?>bbl/riwayat_rekam_bbl',
							dataType : 'json',
							data:{'kode_pasien':kode_pasien,'kategori':kategori},
							success : function(data){
								$('#ModalRiwayatPasienbbl').modal('show');
					...
					function showdetail(kode){
						...
						let kode_bbl = $('#kode_bbl'+kode).html().replace('/','garing'); 
						...
						$(".listdetail").load("<?php echo base_url()?>bbl/detail_riwayat/"+kode_bbl);
