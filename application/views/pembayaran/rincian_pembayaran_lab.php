<div class="main-panel">
	...
	<div class="content">
		<div class="page-inner">
			...
			<div class="row">
				<div class="col-md-12">  
					<div class="card">
						<form class="form-control" spellcheck="false" id="formupdate" method="post" action="<?php echo base_url() ?>pembayaran/update_pembayaran_lab">
							<div class="card-header"> 
								...
								<i class="fas fa-briefcase-medical mr-3 text-primary"></i><span><b>FORM RINCIAN PEMBAYARAN LAB</b></span>
							...
							<div class="card-body">  
								...
								<div class="row" class="collapse" id="customer_collapse"> 
									...
									<div class=" col-md-3 mb-3">
											<span class="input-group-text" style="background: #03b509;color :white">Biaya Pemeriksaan</span>
										<input onclick="this.blur()"  style="text-align: right;font-weight: bold;border-color: #03b509;" type="text" class="form-control " id="total_akhir" name="total_akhir" onkeyup="hitung()" value="<?php echo number_format($row->total_akhir, 0, ',', '.'); ?>" onkeydown="return false" >
									</div> 
	...
	<script type="text/javascript">
		...
		function hitung(){ 
			...
			let total = parseFloat(total_akhir)+parseFloat(biaya_admin) + biaya_tambahan -parseFloat(discount);
			;
