<div class="main-panel">
					...
					<div class="card">
						<form class="form-control" spellcheck="false" id="formupdate" method="post" action="<?php echo base_url() ?>pembayaran/update_pembayaran">
							...
							<div class="card-body">  
								...
								<div class="row" class="collapse" id="customer_collapse">  
									<?php $total_obat = 0; foreach ($detail_obat as $key) { ?>
										<div class="input-group col-md-9 mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text" style="background: #03b509;color :white">Nama Obat</span>
											</div>
											<input onclick="this.blur()"  type="text" class="form-control " id="nama_obat" name="nama_obat" value=" <?php echo $key->nama_obat?>"   onkeydown="return false" style="border-color: #03b509;">
									...
									<div class="input-group col-md-3 mb-3">
										...
										<input onclick="this.blur()"  style="text-align: right;font-weight: bold;border-color: #03b509;" type="text" class="form-control " id="total_akhir" name="total_akhir" onkeyup="hitung()" value="<?php echo $total_obat?>" onkeydown="return false" >
									</div> 
									<?php if (isset($pemeriksaan_lab)): ?>
									<?php if ($pemeriksaan_lab > 0): ?>
	...
	<script type="text/javascript">
		...
		$('#btn_rincikan_pembayaran').on('click',function(){
			...
			Swal.fire({
				title:'Error!',
				text:'Nominal Pembayaran Kosong!',
				icon:'error'
			}).then((result) => {
