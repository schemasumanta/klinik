              ...
              <div class="card-body">  
                ...
                <div class="row" class="collapse" id="customer_collapse"> 
                  ...
                  <div class="input-group col-md-2 mb-3" style="display: none;">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="kode_rekam" name="kode_rekam" value="<?php echo $row->kode_rekam ?>"  onkeydown="return false">
                  </div> 
                  ...
                  <div class="input-group col-md-3 mb-3">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="kode_pasien" name="kode_pasien" value="<?php echo $row->kode_pasien ?>"  onkeydown="return false">
                  </div>
                  ...
                  <div class="input-group col-md-3 mb-3">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="nomor_registrasi" name="nomor_registrasi" value="<?php echo $row->no_registrasi ?>"  onkeydown="return false">
                  </div>
                  ...
                  <div class="input-group col-md-3 mb-3">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="nama_pasien" name="nama_pasien" value="<?php echo $row->nama_pasien ?>"  onkeydown="return false">
                  </div>
                  <div class="input-group col-md-3 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="background: #31ce36;color :white">Jenis Kelamin</span>
                    </div>
                    <input type="text" onclick="this.blur()" class="form-control " id="jk" name="jk" value=" <?php if ($row->jk=="L") { echo "Laki-Laki"; } else{ echo "Perempuan"; }  ?>"  onkeydown="return false">
                  </div>
                  <div class="input-group col-md-3 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="background: #31ce36;color :white">Telepon</span>
                    </div>
                    <input type="text" onclick="this.blur()" class="form-control " id="telepon" name="telepon" value="<?php echo $row->telepon ?>"  onkeydown="return false">
                  </div>
                  ...
                  <div class="input-group col-md-3 mb-3">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="tanggal_lahir" name="tanggal_lahir" value="<?php echo $row->tempat_lahir ?>, <?php echo $row->tanggal_lahir ?>"  onkeydown="return false">
                  </div>  
                  ...
                  <div class="input-group col-md-3 mb-3">
                    ...
                    <input type="text" onclick="this.blur()" class="form-control " id="tanggal_berobat" name="tanggal_berobat" value=" <?php echo $row->tanggal_berobat ?>"  onkeydown="return false">
                  </div> 
                  <div class="input-group col-md-3 mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="background: #31ce36;color :white">Status Pernikahan</span>
                    </div>
                    <input type="text" onclick="this.blur()" class="form-control " id="status_pernikahan" name="status_pernikahan" value="<?php echo $row->status_pernikahan ?>"  onkeydown="return false">
                  </div>  
                  ...
                  <div class="input-group col-md-12 mb-3">
                    ...
                    <textarea spellcheck="false" type="text" onclick="this.blur()" class="form-control " id="alamat" name="alamat"  onkeydown="return false" rows="3" style="text-decoration-line:none;outline: none;  "><?php echo $row->alamat?></textarea> 
                  </div>


                  <div class="col-md-3 mb-3">
                      <span class="input-group-text" style="background: #06820a;color :white">Biaya Admin</span>
                    <input style="text-align: right;" type="text" class="form-control " id="biaya_admin" name="biaya_admin" onfocusout="SeparatorRibuan(this.value,this.id)" onclick="this.blur()"  value="<?php echo number_format ($row->biaya_admin, 0, ',', '.') ?>" onkeyup="hitung()"  onkeydown="return false"  >
                  </div> 

                  <div class="col-md-3 mb-3">
                      <span class="input-group-text" style="background: #06820a;color :white">Disc (Rp)</span>
                    <input style="text-align: right;" type="text" onclick="this.blur()" class="form-control " id="discount" name="discount" value="<?php echo $row->discount ?>" onkeyup="hitung()" onkeydown="return false"  >
                    <!-- <input style="text-align: right;" type="text" onclick="this.blur()" class="form-control " id="jumlah_discount" name="jumlah_discount" value="<?php echo $row->discount ?>" onkeyup="hitung()" onkeydown="return false" > -->
                  </div> 
                  <div class=" col-md-3 mb-3">
                      <span class="input-group-text" style="background: #31ce36;color :white">Biaya Pemeriksaan LAB</span>
                    <input style="text-align: right;font-weight: bold;" type="text" onclick="this.blur()" class="form-control " id="total_akhir" name="total_akhir" onkeyup="hitung()"  value="<?php echo number_format($row->total_akhir, 0, ',', '.') ?>"   onkeydown="return false" >
                  </div> 
                </div>
                <?php if (count($tambahan)>0): ?>
