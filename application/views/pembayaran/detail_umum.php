...
<div class="main-panel">
							...
							<div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 mt-4 ">
										<p style="font-size:25px; text-align: left;padding-top:30px;font-weight: bold; ">DETAIL DATA LAPORAN KEUANGAN REKAM MEDIK UMUM <br>KLINIK HMS MEDIKA</p>	
									</div>
	...
	<script type="text/javascript">
		...
		function exportTableToExcel(mytable, filename = 'Laporan  Rekam Medik ANC'+<?php $tanggal=date("Ymd");echo $tanggal; ?>){
			var downloadLink;
