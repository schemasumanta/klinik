						...
						<div class="card-body">
							<div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6">
										<p style="font-size:25px; text-align: left;padding-top:30px; font-weight: bold; ">DETAIL DATA LAPORAN KEUANGAN REKAM KB UMUM <br>KLINIK HMS MEDIKA</p>	
									</div>
