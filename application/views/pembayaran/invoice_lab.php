...
<body>
<div id="layout_print" style="position:absolute;left:50%;margin-left:-306px;top:0px;width:612px;height:792px;border-style:outset;overflow:hidden">
...
<table class="table">
	...
	<tbody>
		<tr>
    <td  style="text-align: left;font-size: 12px; border:1px solid #565656!important">Biaya Pemeriksaan Lab</td>
    <td style="text-align: center;font-size: 12px; border:1px solid #565656!important">1</td>
    <td style="text-align: right;font-size: 12px; border:1px solid #565656!important"><?php echo number_format(($key->total_akhir), 0, ',', '.'); ?></td>
    <td style="text-align: right;font-size: 12px; border:1px solid #565656!important"><?php echo number_format(($key->total_akhir), 0, ',', '.'); ?></td>
  </tr> 
