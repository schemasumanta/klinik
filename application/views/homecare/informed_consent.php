...
<div style="position:absolute;left:50%;margin-left:-297px;top:50px;width:595px;height:841px;border-style:outset;overflow:hidden" class="pembungkus">
	<div style="position:absolute;left:0px;top:0px">
		...
		<div style="position:absolute;left:198.74px;top:120.06px" class="cls_009">

			<?php if ($key->persetujuan_rawat=="menyetujui"){ ?>
			<span class="cls_009">PERSETUJUAN TINDAKAN MEDIS</span>
				
			<?php }else{ ?>
			<span class="cls_009">PENOLAKAN TINDAKAN MEDIS</span>
			<?php } ?>
		...
		<div style="position:absolute;left:229.97px;top:136.02px" class="cls_009"><span class="cls_009">(INFORMED CONSENT)</span></div>
			...
			<?php }else{ ?>
				*<strike>Laki-laki</strike> / Perempuan
				...
				<div style="position:absolute;left:49.68px;top:315.69px" class="cls_010"><span class="cls_010">Dengan ini menyatakan dengan sesungguhnya telah  

					<?php if($key->persetujuan_rawat=="menyetujui") { ?>
						 menyetujui / <strike>menolak</strike>
					<?php }else{ ?>
						<strike>menyetujui</strike> / menolak 
					<?php } ?> 

				Untuk dilakukan tindakan medis</span></div>
				...
				<?php if ($key->hubungan_dengan_pasien!="diri saya sendiri") {?>
					...
					<?php }else{ ?>
						* <strike>Laki-laki</strike> / Perempuan
						...
						<div style="position:absolute;left:191.42px;top:491.75px" class="cls_010"><span class="cls_010">: <?php echo $key->kode_homecare; ?></span></div>
