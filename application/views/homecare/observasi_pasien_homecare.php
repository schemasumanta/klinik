		...
		<div class="page-inner">
										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class=" col-md-4 mb-3"> 
													...
													<input onclick="this.blur()"  type="text" class="textarea_atas form-control"  id="kode_rekam" name="kode_rekam" value="<?php echo $row->kode_homecare ?>" >
												</div>  
			...
			<script type="text/javascript"> 
				...
				$('#simpan_data_rekam').on('click',function(){
					...
					let link = '<?php echo base_url()?>homecare/simpan_observasi/';
