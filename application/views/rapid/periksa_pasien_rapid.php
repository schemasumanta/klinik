	...
	<div class="content" >
										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class=" col-md-4 mb-3"> 
													...
													<input onclick="this.blur()"  type="text" class="textarea_atas form-control"  id="kode_rapid" name="kode_rapid" value="<?php echo $row->kode_rapid ?>" >
												</div>  
										...
										<div class="col-md-12x mt-3"> 
											...
											<div class="row mb-6">
												...
												<div class="mb-3 col-md-3 "> 
													<span class="input-group-text" id="basic-addon3" style="background:#03b509; color: white; ">Pemeriksaan Rapid</span> 
													<input type="text" onkeyup="hitung()" class="form-control" name="pemeriksaan_rapid" id="pemeriksaan_rapid" value="0" onfocusout="SeparatorRibuan(this.value,this.id)"  >
												</div>  
												...
												<div class="col-md-12" style="margin-top: 70px;">
													...
													<button id="simpan_data_rapid" type="button" class="btn btn-sm btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i> SIMPAN DATA REKAM</button> 
												</div> 
											</div>
										</div> 
		...
		<script type="text/javascript">
			...
			function hitung(){ 
				...
				var pemeriksaan_rapid = $('#pemeriksaan_rapid').val().toString().replace(/\./g,''); 

				let total = parseFloat(pemeriksaan_rapid);
			...
			$('#simpan_data_rapid').on('click',function(){
				...
				let link = '<?php echo base_url()?>rapid/simpan/'+total_akhir;
