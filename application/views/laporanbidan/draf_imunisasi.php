							...
							<div class="table-responsive">
								 <table border="1" id="mytable" class="display table table-bordered table-hover" style="overflow: scroll;"> 
									<thead>
										...
										<tr>
											<th style="text-align: left;" colspan="22">LAPORAN REKAM MEDIK IMUNISASI : <?php echo strtoupper($this->session->nama_pt); ?><br> Tanggal :  <?php echo date("d-M-y"); ?> <br> Alamat :  Jl.Pasir Beureum, Desa.Jagabaya, Kec.Parungpanjang</th>
										</tr>
									...
									<tbody id="show_data" style="font-size: 10px;"> 
										...
										foreach ($laporan_imunisasi as $key ){?>
											...
											<tr style="text-align: center;">
												...
												<td><?php echo $key->kunjungan_neonatus; ?></td>												
