	...
	<div class="content">
		<div class="page-inner">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<?php foreach ($edit_data_lab as $row){ ?>
							<div class="card-header">     
								...
								<div class="card-body">  
									<form class="form-horizontal updatedata" method="post" id="form1" name="form1" action="<?php echo base_url('laboratorium/updatedata') ?>">
										...
										<div class="row mb-3 mt-2 hasilpemeriksaan" style="background:#03b509;border-top-left-radius: 15px;border-bottom-right-radius: 15px;overflow: hidden;border:1px solid #03b509;height: auto;">
											...
											<?php $i=1; foreach ($detail_sub as $key) { ?>

												<div class="col-md-12 listpemeriksaan<?php echo $i ?> listpemeriksaan">
													<div class="row">
														<div class="col-md-6" style="padding: 10px;margin: 0px 0px;border:1px solid #03b509;background:#03b509;"> 
															...
															<select data="" class="form-control"    id="sub_kategori<?php echo $i ?>" name="sub_kategori[]" style="width: 100%" onchange="ceksubkategori(this.id)">
																<option value="0" selected disabled>Pilih Sub Kategori</option>
																<?php foreach ($kategori as $ktg) { ?>
																	<?php if ($ktg->kode_kategori_lab==$key->kode_kategori_lab) { ?>

																		<option value="<?php echo $ktg->kode_kategori_lab ?>" data="<?php echo $ktg->sub_kategori ?>" normal="<?php echo $ktg->nilai_normal ?>"  satuan="<?php echo $ktg->satuan ?>" selected><?php echo $ktg->nama_kategori ?></option>
														...
														<div class="col-md-6" style="padding: 10px;margin: 0px 0px;border:1px solid #03b509;background:#03b509;"> 
															...
															<input type="text" class="form-control" id="hasil_lab<?php echo $i ?>" name="hasil_lab[]" style="width: 100%" value="<?php echo($key->hasil) ?>">

														</div>
														<div class="col-md-6" style="padding: 10px;margin: 0px 0px;border:1px solid #03b509;background:#03b509;"> 
															<span class="input-group-text labelkategori">Nilai Normal</span> 
															<input type="text" class="form-control"  id="nilai_normal<?php echo $i ?>" name="nilai_normal_edit[]" value="<?php echo $key->nilai_normal_akhir ?>">
														</div>

														<div class="col-md-6" style="padding: 10px;margin: 0px 0px;border:1px solid #03b509;background:#03b509;"> 
															<span class="input-group-text labelkategori">Satuan</span> 
															<input type="text" class="form-control"  name="satuan<?php echo $i ?>"  id="satuan<?php echo $i ?>" name="satuan[]" value="<?php echo $key->satuan ?>">
														</div>	
														<a class="btn btn-danger btn-sm text-light" style="position: absolute;bottom: 15px;right: 10px" id="hapussublab<?php echo $i ?>" onclick="hapuskategori(this.id)"><i class="fas fa-trash-alt mr-1" ></i> Hapus</a>
												...
												<div class="col-md-6 input-group btngroup mb-3" style="background:#03b509;">
													...
													<input  class="form-control fw-bold text-right" type="text" id="total_akhir" name="total_akhir" style="font-size: 15px" onfocusout="SeparatorRibuan(this.value,this.id)" value="<?php echo number_format(($row->total_akhir), 0, ',', '.') ?>">
												</div>
												<div class="col-md-3 btngroup" style="background:#03b509;">
												</div>
												<div class="col-md-3 btngroup" style="margin: 0px 0px;">
													<button id="tambahsublab<?php echo count($detail_sub) ?>" type="button" class="btn btn-sm mr-1 btn-round fw-bold text-dark w-100 mt-2 mb-2" style="background: #fff700;position: relative;bottom: 0px;right: 0px" onclick="tambahkategori(this.id)"> + Tambah Kategori</button>
												</div>
											...
											<div class="row mb-2">
												<div class="col-md-12" style="margin-top: 10px;">
													...
													<button id="update_data_lab" type="button" class="btn btn-sm btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i> Update DATA</button> 
												</div> 
											</div>
			...
			<script type="text/javascript"> 
				...
				function tambahkategori(id)
				{
					...
					<div class="col-md-6" style="padding: 10px;margin: 0px 0px;border:1px solid #03b509;background:#03b509;"> 
					<span class="input-group-text labelkategori">Nilai Normal</span> 
					<input type="text" class="form-control" id="nilai_normal`+kode_baru+`" name="nilai_normal_edit[]">
					</div>
				...
				$('#update_data_lab').on('click',function(){
