<?php if (strpos($this->uri->segment(2),'2')!=false) {?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header"> 
								...
								<i class="fas fa-briefcase-medical mr-3"></i><span style="font-size: 25px;"><b>DETAIL LABORATORIUM PASIEN</b></span>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="tabel_rekam" class="table-responsive"> 
										...
										<tr style="background: #03b509;color: white; border: 1px solid  #10aad8;">
											<td style="height:40px;font-weight:bold;text-align: left;" colspan="5">&nbsp;&nbsp;&nbsp;Hasil Laboratorium</td>	
										</tr>
									</tbody>
								</table>
							</div>
							...
							<table  id="tabel_rekamfinal" class="table-responsive">
								<thead>
									<tr>
										<th class="judul1 text-center">No</th>
										<th class="judul1 ">Kategori Lab</th>
								...
								<tbody>
									<?php $no=0; foreach ($detail_sub as $key) {?>
										<tr>
											<th  class="isi text-center"><?php echo ++$no; ?></th>
											<th  class="isi"><?php echo $key->nama_kategori; ?></th>
											<th  class="isi"><?php echo $key->nilai_normal_akhir; ?></th>											
											<th  class="isi text-center"><?php echo $key->satuan; ?></th>											
											<td class="isi text-center"  colspan="4"><?php echo $key->hasil ?></td>
										</tr>
									<?php } ?>
									<tr style="background: #03b509;color: white; border: 1px solid  #10aad8;">
									...
									<tr>
										<th  class="isi tengah" colspan="3"><?php echo ucwords($row->petugas_lab)?></th>											
