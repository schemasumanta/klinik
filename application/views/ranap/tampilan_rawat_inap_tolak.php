  ...
  <div class="content">
    <div class="page-inner">
      <div class="page-header">
        <h4 class="page-title">PENOLAKAN RAWAT INAP</h4>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-sm-12"> 
                 ...
                 <h2 style="font-weight: bold">LIST PENOLAKAN PEMERIKSAAN RAWAT INAP</h2>
            ...
            <div class="card-body">
              <div class="table-responsive belum_periksa" data="DESC" subject="kode_ranap">
                ...
                <table  id="tabel_tolak_ranap"  class="table table-striped table-bordered table-sm " style="width: 100%; height: 30%; overflow-y: scroll;overflow-x: scroll; font-size: 13px; text-align: left;">
                  <thead>
...
<script type="text/javascript"> 
 ...
 dataTable = $('#tabel_tolak_ranap').DataTable( {
      ...
      ajax: {
       url: '<?php echo base_url('ranap/tabel_tolak_ranap')?>',
       type: 'get',
       data: function (data) {
       }
     },
