								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-12">
											...
											<h4 class="text-center mb-3 "><b>PASIEN RAWAT INAP <?php echo $this->session->nama_pt; ?></b></h4>
											<hr style="border: 1px double black">
											<div class="row mb-3">
												<?php foreach ($ranap as $row): ?>
													...
													<div class="col-md-3 input-group">
														<p class="judul" >Kode Ranap</p>
														<p><b>: <?php echo $row->kode_ranap; ?></b></p>
											...
											<tbody id="show_data" style="font-size: 10px;"> 
												...
												foreach ($observasi as $key){?>
													<?php $baris = 0; $list_obat =''; $list_ket=''; $list_qty=''; $list_dosis=''; for ($i=0; $i < count($obat); $i++) {
														...
														if ($obat[$i]->sub_ranap==$key->kode_observasi) {
															if ($list_obat =='') {
