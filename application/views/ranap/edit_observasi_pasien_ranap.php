					...
					<div class="card">
						<?php foreach ($periksa_ranap as $row){ ?>
										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class=" col-md-4 mb-3"> 
													...
													<input onclick="this.blur()"  type="text" class="textarea_atas form-control"  id="kode_ranap" name="kode_ranap" value="<?php echo $row->kode_ranap ?>" >
												</div>  
														...
														<div class="input-group mb-3 col-md-8 listobat">
															...
															<?php }else{ ?>
																...
																<div class="col-md-12" style="margin-top: 70px;">
																	...
																	<button id="update_data_ranap" type="button" class="btn btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i>UPDATE DATA OBSERVASI</button> 
																</div> 
															</div>
														</div> 
							...
							<script type="text/javascript"> 
								...
								$('#update_data_ranap').on('click',function(){
									...
									let link = '<?php echo base_url()?>ranap/update_observasi/';
