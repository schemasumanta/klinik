										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class="col-md-6 mb-3"> 
													...
													<input type="date" class="textarea_atas form-control"  id="tanggal_periksa" name="tanggal_periksa" value="" required="required">
												</div>  
												<div class="col-md-6 mb-3"> 
													<span class="input-group-text labelkolom">Jam Pemeriksaan</span> 
													<input type="time" class="textarea_atas form-control"  id="jam_pemeriksaan" name="jam_pemeriksaan" value="" required="required">
												</div>  
												...
												<div class="col-md-6 mb-3"> 
													...
													<textarea type="text" style="border-color: #03b509; background: #ffffff" class="form-control"  id="hasil_pemeriksaan" name="hasil_pemeriksaan" rows="3" ></textarea> 
												</div>
										...
										<div class="row" id="obat1" style="border: 1px solid #03b509;padding-top: 10px"> 
											...
											<div class="row mb-6">
												<div class="mb-5 col-md-4" id="ttd" style="position: relative"> 
													<span class="input-group-text" style="background: #03b509;color :white; width:100%;"> <i class="far fa-list-alt mr-1"></i> TTD Pasien</span>
													<canvas id="signature-pad-pasien" name="signature-pad-pasien" class="signature-pad-pasien" style="width:100%"></canvas>
													<input type="hidden" name="isi_ttd_pasien" id="isi_ttd_pasien">
												...
												<div class="input-group mb-3 col-md-6">
													...
													<input type="text" class="form-control" name="tarif_dokter" id="tarif_dokter" value="" onkeyup="hitungtotalakhir()">
												</div> 
												...
												<div class="col-md-12" style="margin-top: 70px;">
													...
													<a href="<?php echo site_url('ranap') ?>" class="btn btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
