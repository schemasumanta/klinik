<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($periksa_kehamilan as $row){ ?>
						...
						<div class="card-header">     
							...
							<!-- The modal -->
							<div class="modal fade" id="ModalRiwayatPasienanc" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" style="overflow: scroll;">
								<div class="modal-dialog modal-lg" role="document" >
									<div class="modal-content" >
										<div class="modal-header" style="background:#115222">
											<h4 class="modal-title" id="modalLabel">Daftar Riwayat Pasien ANC - <?php echo ucwords($row->nama_pasien) ?></h4>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class="col-md-4 mb-3"> 
												...
												<input type="text" class="form-control"  id="kode_kehamilan" name="kode_kehamilan" value="<?php echo $row->kode_kehamilan ?>" style="border-color: #03b509; background: #ffffff"  onclick="this.blur()">
											</div>   
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="td" name="td" style="border-color: #03b509; background: #ffffff" >
											</div> 
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="uk" name="uk" style="border-color: #03b509; background: #ffffff" value="<?php echo $uk ?>">
											</div>
											<div class="col-md-2 mb-3">
												<span class="input-group-text labelkolom">paritas</span>

												<input type="text" class="form-control"  id="paritas" name="paritas" style="border-color: #03b509; background: #ffffff"  value="<?php echo $paritas ?>">
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" class="form-control"  id="jarak" name="jarak" style="border-color: #03b509; background: #ffffff" >
											</div>
											...
											<div class="col-md-2 mb-3">
												...
												<input type="text" rows="3" class="form-control"  id="lila" name="lila" style="border-color: #03b509; background: #ffffff" value="<?php echo $lila ?>"> 
											</div>
											...
											<div class="col-md-4 mb-3">
												...
												<select type="text" rows="3" class="form-control"  id="imunisasi_tt" name="imunisasi_tt" style="border-color: #03b509; background: #ffffff" >   

													<option value="0" selected="selected" > Pilih Imunisasi TT</option>
											...
											<div class="col-md-4 mb-3">
												...
												<select type="text" rows="3" class="form-control"  id="jenis_kunjungan" name="jenis_kunjungan" style="border-color: #03b509; background: #ffffff" >   

													<option value="0" selected="selected" > Pilih Jenis Kunjungan</option>
											...
											<div class="col-md-4 mb-3">
												...
												<select type="text" rows="3" class="form-control"  id="table_fe" name="table_fe"  style="border-color: #03b509; background: #ffffff" >

													<option value="0" selected="selected" > Pilih Tamlet FE</option>
											...
											<div class="col-md-4 mb-3"> 
												...
												<input type="date" rows="3" class="form-control"  id="hpht" name="hpht"  style="border-color: #03b509; background: #f18d8d" value="<?php echo $hpht ?>"> 
											</div>

											<div class="col-md-4 mb-3"> 
												<span class="input-group-text labelkolom">HTP</span> 
												<input type="date" rows="3" class="form-control"  id="htp" name="htp"  style="border-color: #03b509; background: #f18d8d" value="<?php echo $htp ?>"> 
											</div>
											...
											<div class="col-md-4 mb-3">
												...
												<span class="input-group-text labelkolom">Riwayat Persalinan</span>

												<select type="text" rows="3" class="form-control"  id="riwayat_persalinan" name="riwayat_persalinan"  style="border-color: #03b509; background: #ffffff" > 

													<option value="0" selected="selected" > Pilih Riwayat Persalinan</option>
											...
											<div class="col-md-4 mb-3">
												...
												<select type="text" rows="3" class="form-control"  id="resti_yang_ada" name="resti_yang_ada"  style="border-color: #03b509; background: #ffffff" > 

													<option value="0" selected="selected" > Pilih Resti Yang ada</option>
												...
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom">Tinggi Fundus (cm)</span> 
													<input type="text" rows="3" class="form-control"  id="tinggi_pundus" name="tinggi_pundus"  style="border-color: #03b509; background: #ffffff" > 
												</div>

												<div class="col-md-4 mb-3">

													<span class="input-group-text labelkolom">Letak janin</span>

													<select type="text" rows="3" class="form-control"  id="letak_janin" name="letak_janin"  style="border-color: #03b509; background: #ffffff" >  
														<option value="0" selected="selected" > -- Letak Jenis --</option> 
												...
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom">Denyut Jantung Janin</span> 
													<input type="text" rows="3" class="form-control"  id="denyut_jantung" name="denyut_jantung"  style="border-color: #03b509; background: #ffffff" > 
												</div>

												<div class="col-md-3 mb-3"> 
													<span class="input-group-text labelkolom">Penunjang</span> 
													<input type="text" rows="3" class="form-control"  id="penunjang" name="penunjang"  style="border-color: #03b509; background: #ffffff" > 
												</div>


												<div class="col-md-4 mb-3">
													<span class="input-group-text labelkolom">Keluhan</span>
													<textarea type="text" rows="2" class="form-control"  id="keluhan" name="keluhan"  style="border-color: #03b509; background: #ffffff"></textarea>  
												</div>
												...
												<div class="col-md-4 mb-3">
													...
													<textarea type="text" rows="2" class="form-control"  id="keterangan" name="keterangan"  style="border-color: #03b509; background: #ffffff"></textarea>  
												</div>
			...
			<div class="modal fade" id="modal_lihat" tabindex="-1" role="dialog" aria-labelledby="modal_lihat_stok" aria-hidden="true">
				...
				<script type="text/javascript">
					...
					$('#btn_riwayat').on('click',function(){
						...
						$.ajax({
							type  : 'GET',
							url   : '<?php echo base_url()?>anc/riwayat_rekam_anc',
							dataType : 'json',
							data:{'kode_pasien':kode_pasien,'kategori':kategori},
							success : function(data){
								$('#ModalRiwayatPasienanc').modal('show');
					...
					function showdetail(kode){
						let kode_kehamilan = $('#kode_kehamilan'+kode).html().replace('/','garing'); 
						...
						$(".listdetail").load("<?php echo base_url()?>anc/detail_riwayat/"+kode_kehamilan);
					}
					...
					let link = '<?php echo base_url()?>anc/simpanrekam_anc/'+total_akhir;
