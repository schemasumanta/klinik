<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($edit_rekam_pasien as $row){ ?>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class=" col-md-4 mb-3"> 
												...
												<input type="text" class="form-control"  id="status_pasien" name="status_pasien"  onclick="this.blur()" style="border-color: #03b509; background: #ffffff" value="<?php echo $row->status_pasien ?>">
											</div>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-2 mb-3"> 
												...
												<input type="text" class="form-control"  id="suhu" name="suhu" required="required" value="<?php echo $row->suhu ?>" style="text-align: center;border-color: #03b509; background: #ffffff" >
											</div>


											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Tensi Darah</span> 
												<input type="text" class="form-control"  id="tensi_darah" name="tensi_darah" required="required"  value="<?php echo $row->tensi_darah ?>" style="text-align: center;border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Saturasi</span> 
												<input type="text" class="form-control"  id="saturasi" name="saturasi" required="required"  value="<?php echo $row->saturasi ?>" style="text-align: center;border-color: #03b509; background: #ffffff">
											</div>



											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Frequensi Pernapasan</span> 
												<input type="text" class="form-control"  id="pernapasan" name="pernapasan" required="required"  value="<?php echo $row->pernapasan ?>" style="text-align: center;border-color: #03b509; background: #ffffff">
											</div>

											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Frequensi Nadi</span> 
												<input type="text" class="form-control"  id="nadi" name="nadi" required="required"  value="<?php echo $row->nadi ?>" style="text-align: center;border-color: #03b509; background: #ffffff">
											</div> 
											...
											<div class="col-md-1 mb-3"> 
												...
												<input style="text-align: center; border-color: #03b509; background: #ffffff" type="text" class="form-control"  id="bb" name="bb" value="<?php echo $row->bb ?>" >
											</div> 

											<div class="col-md-1 mb-3"> 
												<span class="input-group-text labelkolom">TB</span> 
												<input style="text-align: center; border-color: #03b509; background: #ffffff" type="text" class="form-control"  id="tb" name="tb" value="<?php echo $row->tb ?>"  >
											</div>  


											<div class="col-md-6 mb-3"> 
												<span class="input-group-text labelkolom">Keluhan Pasien</span> 
												<textarea type="text" rows="3" class="form-control"  id="keluhan" name="keluhan"  style="border-color: #03b509; background: #ffffff" ><?php echo $row->keluhan ?></textarea>
											</div>



											<div class="col-md-6 mb-3"> 
												<span class="input-group-text labelkolom">H .Pemeriksaan Fisik</span> 
												<textarea type="text" rows="3" class="form-control"  id="hasil_pemeriksaan" name="hasil_pemeriksaan" style="border-color: #03b509; background: #ffffff" ><?php echo $row->hasil_pemeriksaan ?></textarea> 
											</div>


											<div class="col-md-6 mb-3"> 
												<span class="input-group-text labelkolom">Diagnosis</span> 
												<textarea type="text" rows="3" class="form-control"  id="diagnosa" name="diagnosa" style="border-color: #03b509; background: #ffffff"><?php echo $row->diagnosa ?></textarea> 
											</div>


											<div class="col-md-6 mb-3"> 
												<span class="input-group-text labelkolom">Tindakan / Rencana</span> 
												<textarea type="text" rows="3" class="form-control"  id="tindakan_dokter" name="tindakan_dokter"  style="border-color: #03b509; background: #ffffff"> <?php echo $row->tindakan_dokter ?></textarea> 
											</div>


											<div class=" col-md-12 mb-3"> 
												<span class="input-group-text labelkolom">Penunjang</span> 
												<textarea type="text" rows="3" class="form-control"  id="penunjang" name="penunjang" style="border-color: #03b509; background: #ffffff"> <?php echo $row->penunjang ?></textarea> 
											</div>
										...
										<!-- awal -->
										<?php $i=1; foreach ($list_obat as $key) { ?>
											...
											<div class="row">
												...
												<div class=" col-md-4 mb-3"> 
													...
													<input type="text" class="form-control" name="tarif_dokter" id="tarif_dokter" value="<?php echo number_format($row->upah_dokter, 0, ',', '.') ?>"readonly>
												</div>
												<div class=" col-md-4 mb-3"> 
											...
											<div class="row "> 
												<div class="col-md-12" style="margin-top: 70px;">
													...
													<button id="update_data_rekam" type="button" class="btn btn-sm btn-success mr-2" style="float:right" > <i class="fa fa-edit  mr-2"></i> UPDATE DATA REKAM</button> 
												</div> 
											</div>
										</div> 
