						...
						<table  id="tabel_rekamfinal" class="table-responsive">
							<tbody>
								...
								<tr>
									...
									<td class="isi"  colspan="5"><?php echo $row->keluhan ?></td>
								</tr>
								<tr>
									<th  class="judul1">Hasil Pemeriksaan</th>											
									<td class="isi"  colspan="5"><?php echo $row->hasil_pemeriksaan ?></td>
								</tr>
								<tr>
									<th  class="judul1">Diagnosa</th>											
									<td class="isi"  colspan="5"><?php echo $row->diagnosa ?></td>
								</tr>

								<?php if ($row->penyakit!=0): ?>
									
								
								<tr>
									<th  class="judul1">Penyakit</th>											
									<td class="isi"  colspan="5"><?php echo $row->nama_penyakit ?></td>
								</tr>
