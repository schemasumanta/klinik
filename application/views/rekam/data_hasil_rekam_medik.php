...
<script type="text/javascript">
  ...
  function tampil_data(){
    $.ajax({
      type  : 'GET',
      url   : '<?php echo base_url()?>rekam/tampil_data_hasil_rekam',
      // async : true,
      dataType : 'json',
      success : function(data){
        ...
        for(i=0; i<data.length; i++){
          ...
          '<td style="text-align:center">'+data[i].nama_pasien+'</td>'+
                  ...
                  '<a href="rekam/detail/'+data[i].no_registrasi+'" class="btn btn-success btn-sm  btn-flat "style="font-weight: bold;" data="'+data[i].no_registrasi+'" > <i class="fa fa-eye"></i> </a>'+' '+ 
