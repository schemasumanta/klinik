			...
			<div class="row">
					...
					<div class="card">
						<?php foreach ($periksa_kb as $row){ ?>
							...
							<div class="card-header">     
								...
								<!-- The modal -->
								<div class="modal fade" id="ModalRiwayatPasienkb" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document" >
										<div class="modal-content" >
											<div class="modal-header" style="background:#115222">
												<h4 class="modal-title" id="modalLabel">Daftar Riwayat Pasien KB - <?php echo ucwords($row->nama_pasien) ?></h4>
										...
										<div class="col-md-12x mt-3"> 
											<div class="row"> 
												...
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom"> KODE REKAM KB</span> 
													<input type="text" class="form-control"  id="kode_kb" name="kode_kb" value="<?php echo $row->kode_kb ?>" style="border-color: #03b509; background: #ffffff"  onclick="this.blur()">
												</div>   
										...
										<div class="col-md-12x mt-3"> 
											...
											<div class="row">
												...
												<div class="col-md-4 mb-3"> 
													...
													<input type="text" class="form-control" id="jml_anak" name="jml_anak" style="border-color: #03b509; background: #ffffff;  " >
												</div>
												...
												<div class="col-md-4 mb-3"> 
													...
													<select class="form-control " id="akseptor" name="akseptor"  style="border-color: #03b509; background: #ffffff" >
														<option value="0" readonly> Pilih Akseptor Pasien </option>
												...
												<div class="col-md-4 mb-3"> 
													...
													<input type="date" class="form-control"  id="haid_terakhir" name="haid_terakhir"  style="border-color: #03b509; background: #ffffff" >
												</div>

												<!-- <div class="col-md-2 mb-3"> 
													<span class="input-group-text labelkolom">Tensi Darah</span> 
													<input type="text" class="form-control"  id="tensi_darah" name="tensi_darah"  style="border-color: #03b509; background: #ffffff; text-align: center;" >
												</div> -->

												<!-- <div class="col-md-2 mb-3"> 
													<span class="input-group-text labelkolom">Berat Badan</span> 
													<input type="text" class="form-control"  id="berat_badan" name="berat_badan"  style="border-color: #03b509; background: #ffffff; text-align: center;"  >
												</div> -->
											...
											<div class="row"> 
												<div class="col-md-4 mb-3"> 
													...
													<textarea type="text" class="form-control"  id="efek_samping" name="efek_samping"  style="border-color: #03b509; background: #ffffff"  ></textarea>
												</div> 


												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom" style="font-size: 15px">Komplikasi</span> 
													<textarea type="text" class="form-control"  id="komplikasi" name="komplikasi" style="border-color: #03b509; background: #ffffff"  ></textarea> 
												</div>


												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom">Tindakan/Rencana</span> 
													<textarea type="text" class="form-control"  id="tindakan_dokter" name="tindakan_dokter" style="border-color: #03b509; background: #ffffff" ></textarea> 
												</div>
											...
											<div class="row">
												...
												<div class="col-md-8 mb-3"> 
													...
													<select type="text" class="form-control" id="alat_kontrasepsi" name="alat_kontrasepsi" style="border-color: #03b509; background: #ffffff" >
														<option value="0" selected="selected" disabled="disabled">Pilih Alat Kontrasepsi</option>
												...
												<div class="col-md-4 mb-3"> 
													...
													<input type="date" class="form-control"  id="tanggal_kembali" name="tanggal_kembali"  style="border-color: #03b509; background: #ffffff" > 
												</div>
											...
											<br>
													...
													<div class="row mb-6"> 
														...
														<div class="col-md-12" style="margin-top: 70px;">
															...
															<a href="<?php echo site_url('rekam_kb') ?>" class="btn btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
															<button id="simpan_data_rekam_kb" type="button" class="btn btn-success mr-2" style="float:right" > <i class="fa fa-save  mr-2"></i> SIMPAN DATA REKAM</button> 
														</div> 
													</div>
												</div> 
				...
				<div class="modal fade" id="modal_lihat" tabindex="-1" role="dialog" aria-labelledby="modal_lihat_stok" aria-hidden="true">
					...
					<script type="text/javascript">
						...
						$('#simpan_data_rekam_kb').on('click',function(){
					...
					let link = '<?php echo base_url()?>rekam_kb/simpanrekam_rekam_kb/'+total_akhir;
					...
					$('.simpandata').submit(); 
						...
						$('#btn_riwayat').on('click',function(){
							...
							$.ajax({
								type  : 'GET',
								url   : '<?php echo base_url()?>rekam_kb/riwayat_rekam_kb',
								dataType : 'json',
								data:{'kode_pasien':kode_pasien,'kategori':kategori},
								success : function(data){
									$('#ModalRiwayatPasienkb').modal('show');
						...
						function showdetail(kode){
							...
							let kode_kb = $('#kode_kb'+kode).html().replace('/','garing'); 
							...
							$(".listdetail").load("<?php echo base_url()?>rekam_kb/detail_riwayat/"+kode_kb);
