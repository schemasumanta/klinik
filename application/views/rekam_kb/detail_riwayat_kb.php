	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header"> 
				...
				<?php foreach ($detail_rekam_pasien_kb as $row): ?>
			...
			<table  id="tabel_rekamfinal" class="table-responsive">
				<tbody>
					...
					<tr>
						...
						<td class="isi"  colspan="2"><?php echo $row->berat_badan ?> Kg</td>
					</tr>
					...
					<tr>
						...
						<td class="isi"  colspan="4"><?php echo $row->efek_samping ?></td>
					</tr>
					<tr>
						<th  class="judul1">Komplikasi</th>											
						<td class="isi"  colspan="4"><?php echo $row->komplikasi ?></td>
					</tr>
					<tr>
						<th  class="judul1">Alat Kontrasepsi</th>											
						<td class="isi"  colspan="4"><?php echo $row->alat_kontrasepsi ?></td>
					</tr>
