<div class="main-panel">
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<?php foreach ($edit_rekam_pasien_kb as $row){ ?>
								...
								<form class="form-horizontal updatedata" method="post" id="form1" name="form1">
									...
									<div class="col-md-12x mt-3"> 
										<div class="row"> 
											...
											<div class=" col-md-4 mb-3"> 
												...
												<input type="text" class="form-control"  id="kode_kb" name="kode_kb" value="<?php echo $row->kode_kb ?>"  onclick="this.blur()"  style="border-color: #03b509; background: #ffffff"  >
											</div>  
											...
											<div class="col-md-2 mb-3"> 
												...
												<textarea type="text" class="form-control" id="umur" name="umur" onclick="this.blur()"  style="border-color: #03b509; background: #ffffff"  ><?php echo $row->umur ?></textarea>
											</div>
									...
									<div class="col-md-12x mt-3"> 
										<div class="row">
											...
											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Jumlah Anak</span> 
												<input type="text" class="form-control"  id="jml_anak" name="jml_anak" style="border-color: #03b509; background: #ffffff"  value="<?php echo $row->jml_anak ?>" >
											</div>


											<div class="col-md-4 mb-3"> 
												<span class="input-group-text labelkolom">Akseptor</span> 
												<select class="form-control " id="akseptor" name="akseptor" style="border-color: #03b509; background: #ffffff" >
													<option value="<?php echo $row->akseptor ?>"  ><?php echo $row->akseptor ?> </option>
											...
											<div class="col-md-4 mb-3"> 
												<span class="input-group-text labelkolom">Haid Terakhir</span> 
												<input type="date" class="form-control"  id="haid_terakhir" name="haid_terakhir" style="border-color: #03b509; background: #ffffff"   value="<?php echo $row->haid_terakhir ?>">
											</div>
											...
											<div class="col-md-2 mb-3"> 
												<span class="input-group-text labelkolom">Tensi Darah</span> 
												<input type="text" class="form-control"  id="tensi_darah" name="tensi_darah" style="border-color: #03b509; background: #ffffff"   value="<?php echo $row->tensi_darah ?>">
											</div>

												<!-- <div class="col-md-2 mb-3"> 
													<span class="input-group-text labelkolom">Berat Badan</span> 
													<input type="text" class="form-control"  id="berat_badan" name="berat_badan" style="border-color: #03b509; background: #ffffff"   value="<?php echo $row->berat_badan ?>">
												</div>   -->

											</div> 
											<label class="mb-3">Keluhan Pasien</label> 
											<div class="row"> 
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom">Efek Samping</span> 
													<textarea type="text" class="form-control"  id="efek_samping" name="efek_samping"  style="border-color: #03b509; background: #ffffff"  ><?php echo $row->efek_samping ?></textarea>
												</div> 
												

												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom" style="font-size: 15px">Komplikasi</span> 
													<textarea type="text" class="form-control"  id="komplikasi" name="komplikasi" style="border-color: #03b509; background: #ffffff"  ><?php echo $row->komplikasi ?></textarea> 
												</div>
												...
												<div class="col-md-8 mb-3"> 
													<span class="input-group-text labelkolom">Alat Kontrasepsi</span> 

													<select type="text" class="form-control" id="alat_kontrasepsi" name="alat_kontrasepsi" value="<?php echo $row->alat_kontrasepsi ?>" style="border-color: #03b509; background: #ffffff" >
														<option value="<?php echo $row->alat_kontrasepsi ?>" selected="selected" > <?php echo $row->alat_kontrasepsi ?></option>
												...
												<div class="col-md-4 mb-3"> 
													<span class="input-group-text labelkolom">Tanggal kembali</span> 
													<input type="date" class="form-control"  id="tanggal_kembali" name="tanggal_kembali"  value="<?php echo $row->tanggal_kembali ?>" style="border-color: #03b509; background: #ffffff"  > 
												</div>
											...
											<?php $i=1; foreach ($detail_obat as $key) { ?>
												...
												<div class="row" id="obat<?php echo $i ?>" style="border: 1px solid #e4e4e4;padding-top: 10px"> 
													...
													<span class="input-group-text" id="basic-addon3" style="display: none;background:#03b509; color: white; ">Sub Total</span> 
													<input style="display: none;" type="text" class="form-control" id="subtotal<?php echo $i ?>" name="subtotal[]" placeholder="Total" disabled="disabled" readonly="readonly" value="<?php echo number_format(($key->subtotal), 0, ',', '.') ?>">   
												...
												<div class="row ">
													...
													<div class="col-md-4 mb-3"> 
														<span class="input-group-text labelkolom">Fee Dokter</span> 
														<input type="text" class="form-control" name="tarif_dokter" id="tarif_dokter" value="<?php echo number_format($row->upah_dokter, 0, ',', '.') ?>"  style="border-color: #03b509; background: #ffffff"  disabled>
													</div>
													...
													<div class="col-md-12" style="margin-top: 70px;">
														...
														<a href="<?php echo site_url('rekam_kb') ?>" class="btn btn-sm btn-danger mr-2 float-sm-right" style="float:right" ><i class="fa fa-times  mr-2"></i> BATAL</a>
														<button id="update_data_rekam_kb" type="button" class="btn btn-sm btn-primary mr-2" style="float:right" > <i class="fa fa-edit  mr-2"></i> UPDATE DATA REKAM</button> 
													</div> 
												</div>
											</div> 
			...
			<div class="modal fade" id="modal_lihat" tabindex="-1" role="dialog" aria-labelledby="modal_lihat_stok" aria-hidden="true">
				...
				<script type="text/javascript">
					...
					$('#update_data_rekam_kb').on('click',function(){
					...
					if (cek=='false') {
						...
						let link = '<?php echo base_url()?>rekam_kb/updaterekam_kb/'+total_akhir;
