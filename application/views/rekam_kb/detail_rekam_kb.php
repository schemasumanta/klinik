				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"> 
							...
							<?php foreach ($detail_kb as $row): ?>

								<h4 style="font-weight: bold;margin-top: 10px;"><?php echo ucwords($row->kode_kb);?></h4>								
							<?php endforeach ?>
						...
						<table  id="tabel_rekamfinal" class="table-responsive">
							<tbody> 
								...
								<tr>
									<th  class="judul1">Tensi Darah</th>	 
									<td class="isi" ><?php echo $row->tensi_darah ?>  mmHg</td> 
									<th  class="judul1" >Berat Badan</th> 
									<td class="isi"  colspan="3"><?php echo $row->berat_badan ?> Kg</td>
								</tr>
								...
								<tr>
									<th  class="judul1">Efek Samping</th>											
									<td class="isi"  colspan="5"><?php echo $row->efek_samping ?></td>
								</tr>
								<tr>
									<th  class="judul1">Komplikasi</th>											
									<td class="isi"  colspan="5"><?php echo $row->komplikasi ?></td>
								</tr>
								<tr>
									<th  class="judul1">Alat Kontrasepsi</th>											
									<td class="isi"  colspan="5"><?php echo $row->alat_kontrasepsi ?></td>
								</tr>
